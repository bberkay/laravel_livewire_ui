        ...
        <tbody>
            @foreach($data as $message)
                <tr>
                    ...
                    <td>
                        <button class = "btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#showMessageModal" wire:click="showMessageModal('Message', '{{ $message->message }}')" data-bs-config='{"delay": 15, "title": "Modal Başlık"}'>
